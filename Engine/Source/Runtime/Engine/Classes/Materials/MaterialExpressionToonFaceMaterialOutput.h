...
#include "MaterialExpressionToonFaceMaterialOutput.generated.h"

/** Toon材质的自定义属性输出. */
UCLASS(MinimalAPI, collapsecategories, hidecategories = Object)
class UMaterialExpressionToonFaceMaterialOutput : public UMaterialExpressionCustomOutput
{
	...
	UPROPERTY()
	FExpressionInput ToonShadowDataSDF;
	UPROPERTY()
	FExpressionInput FaceForwardVector;
	UPROPERTY()
	FExpressionInput FaceRightVector;
	UPROPERTY()
